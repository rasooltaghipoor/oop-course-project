...
- نمایش لیست مرتب شده بازیکنان بر اساس یک فیلد (نام، سن، مبلغ قرارداد)
- نمایش سه گلزن برتر تیم
- نمایش اطلاعات بازیکنانی که مبلغ قرارداد آن ها از میانگین مبلغ قراردادها بیشتر است.
- گروه بندی و نمایش لیست کل بازیکنان بر اساس فیلدی که بازی می کنند. به عنوان مثال ابتدا دروازه بان ها، سپس بازیکنان پست دفاع، سپس هافبک و ... نمایش داده شوند.
